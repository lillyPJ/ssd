...
model_def = caffe_root + 'models/VGGNet/shopSign/SSD_300x300/deploy.prototxt'
model_weights = caffe_root + 'models/VGGNet/shopSign/SSD_300x300/VGG_shopSign_SSD_300x300_iter_20000.caffemodel'
...
img_root = '/home/lili/datasets/shopSign/img/test/'

...
model_name = "boat5_boat5_{}".format(job_name)
...
with open(job_file, 'w') as f:
  ...
  f.write('python ./python/drawTrainingProcess.py boat5_boat5_longer_conv_300x300.log.train boat5_boat5_longer_conv_300x300.log.test textBox_pretrain_boat5.png')

...
gt_dir= '/home/lili/datasets/ICDAR2013/gt/test/txt/word/';
...
for ii=1:nImg
    ...
    icdar_submit_path=[icdar_test_dir,'res_',name,'.txt'];
...
fprintf('recall = %.3f, precision = %.3f, fmeasure = %.3f\n', recall, precision, f_measure);

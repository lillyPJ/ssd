clear all;
icdar_2013_dataset_root = '/home/lili/datasets/VOC/VOCdevkit/shopSign/';
test_list_file=[icdar_2013_dataset_root, 'ImageSets/Main/test.txt'];
img_dir=[icdar_2013_dataset_root,'JPEGImages/'];
gt_dir= '/home/lili/datasets/shopSign/gt/test/txt/';
% multi-scale detection results directory
dt_dir = '/home/lili/codes/ssd/caffe-ssd/data/shopSign/test_bb/';
